...
//This function makes the cities file. It makes a get request to receive all of the cities from data.gov.il api.
//It awaits to receive all of the
const getCities = async () => {
  ...
  await Promise.all(
    cities.result.records.map(async (r, i) => {
